...
echo -e "\033[2A\033[97mHere goes the Kiosk installer... You need to enter a URL here for the Kiosk to launch to: \033[0m\c"
read URL
echo
...
URL=\"$URL\"
echo -e "\033[2A\033[97mOK - URL set. Doing my business now, hang on...\033[0m\c"
sudo apt -y update
